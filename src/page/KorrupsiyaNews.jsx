...
import newImg1 from '../image/newsImg2.webp'
import newImg2 from '../image/newImg1.webp'
import newImg3 from '../image/news4.webp'

function KorrupsiyaNews() {
                ...
                <div className="container">
                    ...
                    <div className={`home_container ${isVisible ? "menu-visible" : ""}`}>
                        ...
                        <div className='all_home' style={{ lineHeight: '1.6' }}>
                            <h2 style={{ color: '#003366', textAlign: "center" }}>KORRUPSIYAGA QARSHI KURASH</h2>
                            <div className="new_container">
                                <NewCard image={newImg1} title="“Yangi “Yoshlar markazi” ochildi!" date="2024-09-29" number="1" />
                                <NewCard image={newImg2} title="“Shashka musobaqasining Respublika final bosqichi boshlandi" date="2024-09-27" number="12" />
                                <NewCard image={newImg3} title="“26-sentabr - Davlat xavfsizlik xizmati kuni!" date="2024-09-27" number="25" />
                                <NewCard image={newImg3} title="“26-sentabr - Davlat xavfsizlik xizmati kuni!" date="2024-09-27" number="25" />

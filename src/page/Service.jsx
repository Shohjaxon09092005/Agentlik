...
const services = [
    {
        id: 1,
        name: "Nogironligi bo'lgan yoshlarga asbob-uskuna va mehnat qurollari ajratishda subsidiya ajratish",
        link: "https://my.gov.uz/oz/service/633?_gl=1*fqb1g3*_ga*MTE3OTM2MDQwNS4xNzA4NTg2ODYx*_ga_XESZL19D7L*MTcwODY5MDkzNC45LjEuMTcwODY5MjU5Ny4wLjAuMA.."
    },
    {
        id: 2,
        name: "Nogironligi bo'lgan yoshlarga o'qish davrida yashash va transport xarajatlari uchun subsidiya ajratish",
        link: "https://my.gov.uz/oz/service/629?_gl=1*poevux*_ga*MTE3OTM2MDQwNS4xNzA4NTg2ODYx*_ga_XESZL19D7L*MTcwODY5MDkzNC45LjEuMTcwODY5MjU5Ny4wLjAuMA.."
    },
    {
        id: 3,
        name: "Nogironligi bo'lgan yoshlarga o'qish xarajati uchun subsidiya ajratish",
        link: "https://my.gov.uz/oz/service/628?_gl=1*poevux*_ga*MTE3OTM2MDQwNS4xNzA4NTg2ODYx*_ga_XESZL19D7L*MTcwODY5MDkzNC45LjEuMTcwODY5MjU5Ny4wLjAuMA.."
    },
    {
        id: 4,
        name: "Xalqaro imtihon tizimlari bo'yicha yuqori ball (daraja) to'plagan yoshlarga imtihon topshirish xarajatlarini to'liq qoplab berish",
        link: "https://my.gov.uz/oz/service/413?_gl=1*poevux*_ga*MTE3OTM2MDQwNS4xNzA4NTg2ODYx*_ga_XESZL19D7L*MTcwODY5MDkzNC45LjEuMTcwODY5MjU5Ny4wLjAuMA.."
    },
    {
        id: 5,
        name: "\"Bir million dasturchi\" loyihasi doirasidagilar uchun kompyuter xarid qilish uchun kompensatsiya olish",
        link: "https://my.gov.uz/oz/service/523?_gl=1*13ayd8g*_ga*MTE3OTM2MDQwNS4xNzA4NTg2ODYx*_ga_XESZL19D7L*MTcwODY5MDkzNC45LjEuMTcwODY5Mjk0Ny4wLjAuMA.."
    }
];
                ...
                <div className="container">
                    ...
                    <div className={`home_container ${isVisible ? "menu-visible" : ""}`}>
                        ...
                        <div style={{ lineHeight: '1.6' }}>
                            <h2 style={{ color: '#003366', textAlign: "center" }}>DAVLAT XIZMATLARI REESTRI</h2>
                            <div className="jamoat_container">
                                <table className="service-table">
                                    <thead>
                                        <tr>
                                            <th>№</th>
                                            <th>Davlat xizmatlari</th>
                                            <th>Havola</th>
                                        </tr>
                                    </thead>
                                    <tbody>

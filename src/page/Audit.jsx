                    ...
                    <div className="container">
                        ...
                        <div className={`home_container ${isVisible ? "menu-visible" : ""}`}>
                            ...
                            <div style={{ lineHeight: '1.6' }}>
                                <h2 style={{ color: '#003366', fontSize: "24px" }}>ICHKI AUDIT</h2>
                                <ol>
                                    <li>
                                        Yoshlar ishlari agentligi ichki audit xizmati faoliyatining  2024-yil 6 oylik faoliyati boʻyicha  HISOBOTI /{' '}
                                        <a href="https://api-portal.gov.uz/uploads/7f94dddb-0efc-03a7-3ea9-23eb55278e23_media_.pdf" target="_blank" rel="noopener noreferrer" style={{ color: 'blue' }}>
                                            havola
                                        </a>
                                    </li>
                                    <li>
                                        Yoshlar ishlari agentligi Ichki audit xizmati faoliyati umumiy natijalari /{' '}
                                        <a href="https://api-portal.gov.uz/uploads/c0fb67db-d15c-87e6-82cf-9e08b76a136f_media_.xlsx" target="_blank" rel="noopener noreferrer" style={{ color: 'blue' }}>
                                            havola
                                        </a>
                                    </li>

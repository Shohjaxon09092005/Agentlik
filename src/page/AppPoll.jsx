...
import Pol2 from '../components/Pol2'
import Pol3 from '../components/Pol3'
                    ...
                    <div className="container">
                        ...
                        <div className={`home_container ${isVisible ? "menu-visible" : ""}`}>
                            ...
                            <div style={{ lineHeight: '1.6' }}>
                                <h2 className='text_table_content' style={{ color: '#003366', fontSize: "24px",textAlign:"center" }}>So‘rovnomalar</h2>

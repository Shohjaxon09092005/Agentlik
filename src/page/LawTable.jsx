...
const laws = [
    {
        ...
        link: "https://lex.uz/docs/-3026246"
    },
    {
        id: 2,
        date: "2019 yil 2 dekabr",
        number: "O'RQ-585-son",
        name: "Volontyorlik faoliyati to'g'risida",
        link: "https://lex.uz/docs/-4623999"
    },
    {
        id: 3,
    ...
    },
    {
        ...
        number: "O'RQ-747-son",
        name: "Yoshlar bilan ishlash tizimi takomillashtirilishi munosabati bilan O'zbekiston Respublikasining ayrim qonun hujjatlariga qo'shimchalar kiritish to'g'risida",
        link: "https://lex.uz/uz/docs/-5837339"
    },
    {
        id: 5,
        date: "2016 yil 14 sentabr",
                ...
                <div className="container">
                    ...
                    <div className={`home_container ${isVisible ? "menu-visible" : ""}`}>
                        ...
                        <div style={{ lineHeight: '1.6' }}>
                            <h2 style={{ color: '#003366', fontSize: "24px",textAlign:"center" }}>QONUN HUJJATLARI</h2>
                            <div className="jamoat_container">
                                <table className="law-table">
                                    <thead>
                                        <tr>
                                            <th>T/R</th>
                                            <th>Normativ-huquqiy hujjat qabul qilingan sana</th>
                                            <th>Normativ-huquqiy hujjat soni</th>
                                            <th>Normativ-huquqiy hujjat nomi</th>
                                        </tr>
                                        <tr>
                                            <th colSpan="4" className="main-header_table">O'zbekiston Respublikasining Qonunlari</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {laws.map((law) => (
                                            <tr key={law.id}>
                                                <td>{law.id}</td>
                                                <td>{law.date}</td>
                                                <td><a href={law.link}>{law.number}</a></td>
                                                <td>{law.name}</td>
                                            </tr>
                                        ))}
                                    </tbody>
                                    <thead>
                                        ...
                                        <tr>
                                            <th colSpan="4" className="main-header_table">O‘zbekiston Respublikasi Prezidentining Farmonlari</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {laws.map((law) => (

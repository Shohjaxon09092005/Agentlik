                    ...
                    <div className="container">
                        ...
                        <div className={`home_container ${isVisible ? "menu-visible" : ""}`}>
                            ...
                            <div style={{ lineHeight: '1.6' }}>
                                <h2 className='text_table_content' style={{ color: '#003366', fontSize: "24px" }}>Mas'ul xodim</h2>
                                <div className="table-container_custom">
                                    <h3>Ma'lumotlarni joylash bo'yicha mas'ul shaxs</h3>
                                    <table className="custom-table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>1</td>
                                                <td>Yusupov Doniyorbek Ibrohimovich</td>
                                                <td>Axborot va media bosh mutaxassisi</td>
                                                <td>appleidexotic@gmail.com</td>
                                                <td>(71) 209-01-04 (105)</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>

...
import newImg2 from '../image/newsImg3.webp'
import newImg3 from '../image/newImg1.webp'
                ...
                <div className="container">
                    ...
                    <div className={`home_container ${isVisible ? "menu-visible" : ""}`}>
                        ...
                        <div className='all_home' style={{ lineHeight: '1.6' }}>
                            <h2 style={{ color: '#003366', textAlign: "center" }}>YOSHLAR SIYOSATI</h2>
                            <div className="new_container">
                                ...
                                <NewCard image={newImg3} title="“Biznes marafon”ning 5-mavsumi davom etmoqda" date="2024-09-27" number="25" />

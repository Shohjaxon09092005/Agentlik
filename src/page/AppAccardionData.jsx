...
import AccardionData from '../components/AccardionData';
function AppAccardionData() {
                    ...
                    <div className="container">
                        ...
                        <div className={`home_container ${isVisible ? "menu-visible" : ""}`}>
                            ...
                            <div style={{ lineHeight: '1.6' }}>
                                <h2 className='text_table_content' style={{ color: '#003366', fontSize: "24px" }}>Savollar va javoblar</h2>
...
export default AppAccardionData

                ...
                <div className="container">
                    ...
                    <div className={`home_container ${isVisible ? "menu-visible" : ""}`}>
                        ...
                        <div style={{ lineHeight: '1.6' }}>
                            <h2 style={{ color: '#003366', fontSize: "24px" }}>IJTIMOIY AHAMIYATGA OID MA'LUMOTLAR</h2>
                            <ol>
                                <li>
                                    O'zbekiston Respublikasi Yoshlar ishlari agentligi 2024-yil birinchi yarim yillik ish rejasi /{' '}
                                    <a href="https://api-portal.gov.uz/uploads/04be34e1-306c-b600-fe2d-3033d11b81ee_media_.pdf" target="_blank" rel="noopener noreferrer" style={{ color: 'blue' }}>
                                        .pdf
                                    </a>
                                </li>
                                <li>
                                    O'zbekiston Respublikasi Prezidenti rahbarligida 2023 yil 11 aprel kuni “Yoshlar siyosati sohasidagi ishlar natijadorligini oshirish hamda ular bilan ishlash tizimini yanada takomillashtirish chora-tadbirlari” yuzasidan o'tkazilgan videoselektor yig'ilishida berilgan topshiriqlar ijrosi yuzasidan MA'LUMOT /{' '}
                                    <a href="https://api-portal.gov.uz/uploads/53d65e1e-57c0-86d0-7fb3-aad26baad788_media_.pdf" target="_blank" rel="noopener noreferrer" style={{ color: 'blue' }}>
                                        .pdf
                                    </a>
                                </li>
                                <li>
                                    “O'zbekiston – 2030” strategiyasini 2023 yilda sifatli va o'z vaqtida amalga oshirish chora-tadbirlari to'g'risida 2023-yil 11-sentabrdagi PQ-300 son qarorida Yoshlar ishlari agentligiga belgilangan bandlar ijrosi bo'yicha TAHLILIY MA'LUMOT /{' '}
                                    <a href="https://api-portal.gov.uz/uploads/42e4f58a-cd8a-23ed-2d70-5138d613acf3_media_.pdf" target="_blank" rel="noopener noreferrer" style={{ color: 'blue' }}>
                                        .pdf
                                    </a>
                                </li>
                                <li>
                                    “Yoshlar oyligi” doirasida o'tkazilgan tadbirlar va “Butunjahon yoshlar festivali” haqida{' '}
                                    <a href="https://api-portal.gov.uz/uploads/d7706e89-2a6b-0c5a-3f98-cef9407ad7c1_media_.docx" target="_blank" rel="noopener noreferrer" style={{ color: 'blue' }}>
                                        .docx
                                    </a>
                                </li>
                            </ol>
